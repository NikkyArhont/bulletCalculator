...
class AppStateNotifier extends ChangeNotifier {
  ...
  Future setFirstTime(bool value) async {
    _isFirstTime = value;
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('kIsFirstTime', value);
    notifyListeners();
  }
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? ShootPageWidget() : InitPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: UpdateShootDataWidget.routeName,
          path: UpdateShootDataWidget.routePath,
          builder: (context, params) => UpdateShootDataWidget(),
        ),
        FFRoute(
          name: WeaponListWidget.routeName,
          path: WeaponListWidget.routePath,
          builder: (context, params) => WeaponListWidget(),
        ),
        FFRoute(
          name: AddWeaponWidget.routeName,
          path: AddWeaponWidget.routePath,
          builder: (context, params) => AddWeaponWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: SuccsedEnterWidget.routeName,
          path: SuccsedEnterWidget.routePath,
          builder: (context, params) => SuccsedEnterWidget(),
        ),
        FFRoute(
